...
export default function BookDetails() {
  ...
  return (
    <div className="">
      ...
      {book && (
        <div className="max-w-4xl mx-auto p-2 md:p-5 shadow-primary bg-white rounded-lg shadow md:mt-10 mt-5">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="md:col-span-2 space-y-4 my-5 ">
              <h1 className="text-2xl font-bold text-center md:text-start  text-gray-800">
                {book.title}
              </h1>
              ...
              {/* Description */}
              <p className="text-gray-700 leading-relaxed indent-4 sm:indent-0 text-sm sm:text-base">
                {book.description}
              </p>
            ...
            `}
                ...
                <Link
                  to={`/`}
                  className="bg-indigo-600 text-white hover:bg-indigo-700 px-4 py-2 rounded-lg mt-4 inline-block ms-2"
                >
                  Back
                </Link>
              </div>
