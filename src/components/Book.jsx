    ...
    <div>
      <div className="border border-primary p-4 rounded-lg shadow hover:shadow-lg transition">
        ...
        <div className="text-center space-y-2">
          <h5 className="text-lg font-semibold ">Book Title {book}</h5>
          <p className="text-gray-600">Author Name</p>
          <div className="hidden md:block space-y-2">
            {["travel", "science"].map((genre) => (
              <span
                key={genre}
          ...
          <button className="mt-2 bg-indigo-500 text-white px-4 py-2 rounded hover:bg-indigo-700">
            View Details
          </button>
        </div>
      </div>
